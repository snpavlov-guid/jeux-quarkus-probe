ALTER TABLE football."Stage"
    ADD COLUMN groups character varying(32)[];

ALTER TABLE football."Stage"
    ADD COLUMN prev_stage_id bigint;

ALTER TABLE football."Stage"
    ADD COLUMN prev_plays character varying(16);
...
ALTER TABLE football."Match"
    ADD COLUMN "group" character varying(32);

CREATE INDEX idx_match_group ON football."Match" USING btree ("group");
...
SET groups = ARRAY['A', 'B']::varchar(32)[]
