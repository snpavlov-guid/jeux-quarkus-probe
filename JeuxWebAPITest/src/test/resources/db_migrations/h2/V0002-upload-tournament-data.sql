...
INSERT INTO football."Tournament" (id, name, st_year, fn_year, league_id)
VALUES (40, 'RPL SubOrder Test', 2024, 2025, 1);

INSERT INTO football."Stage" (id, name, "order", league_id, tournament_id)
VALUES (60, 'SubOrder Stage', 1, 1, 40);
...
INSERT INTO football."Match" (
    ...
    (4001, 1, 'R1', TIMESTAMP WITH TIME ZONE '2024-08-01 18:00:00+03:00', 2, 0, 'Moscow', 'SubOrder Arena 1', 1, 40, 60, 41, 42),
    (4002, 1, 'R1', TIMESTAMP WITH TIME ZONE '2024-08-01 20:00:00+03:00', 1, 0, 'Moscow', 'SubOrder Arena 2', 1, 40, 60, 43, 44);
